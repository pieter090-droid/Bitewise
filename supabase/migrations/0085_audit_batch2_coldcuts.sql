-- Fase 1 audit, batch 2 (hartig) — deel 5 (slot): leesronde cold_cuts (429).
-- Elk product individueel gelezen. Daarmee is batch 2 (hartig) compleet.
--
-- Hoofdbevindingen:
--  K1 22 snackworsten -> meat_snacks: Bifi x5, kabanossi x2 (K-spelling
--     miste in de regel), aperitiefsalami, snack-salami, en de knak-/bock-/
--     cocktail-/partyworstjes-groep x13 (borrelsnack, geen broodbeleg).
--     Regelwortel R18b (meat_snacks-regel uitgebreid).
--  K2 14 rookworsten (Unox/AH/Gwoon, incl. vegan en stamppot-saucisse) ->
--     meal_components (rookworst is een maaltijdcomponent, geen beleg);
--     + tortellini, verse kipworsten, ovenpasta, hamburgers, braadworst,
--     spekreepjes -> meal_components (totaal 20).
--  K3 12 maaltijden (pizza's x4, nasi x2, witlof-ham-kaas x2, quiche,
--     lamb shank, babymaaltijd, M&S tagliatelle) -> ready_meals;
--     regelwortel R18 (exclusies in de vleeswarenregel).
--  K4 2 Cup-a-Soup -> soups; Maggi ham-kaassaus -> sauces_dips; 3 smeer-
--     salades (Fleischsalat, Johma, AH salade-specialiteit) ->
--     savory_spreads; ham-kaascroissant -> bread_bakery; Lay's Wayy chips
--     -> crisps_chips; oven-frikandellen + fricadelle -> fried_snacks.
--  K5 Garden Gourmet wok pieces -> meat_alternatives_non_swap; vegan BELEG
--     (vegan salami/boterhamworst/seitan slices) blijft bewust in
--     cold_cuts (zelfde gebruik als vleeswaren-beleg).
--  K6 3 review_required (Crispy Twist, Vegan Deli Bell Pepper, Mini crocq).
--  NB filet americain-groep, pates/rilettes, tapas-rolletjes en tostiham
--     blijven bewust in cold_cuts.
--
-- `products` wordt nergens aangeraakt. `products` blijft raw.

create table if not exists public._snapshot_0085_before as
...
where barcode in (
  '4251097400136','4251097401447','4251097402659','4251097408903','4251097420783',
  '4056489609124','20044596','27039984','5908230539343',
  '8720182327918','8712100806087','8720182686794','8714100753736','8714100772928',
  '8718989014988','8714100330937','8718906385559','4056489875789','4260193513961',
  '8710624244279','4056489027751','8710624241155',
  '8710400252146','8710604729611','8720182718495','8710624241070','8714100777701',
  '8710400067405','8710400250456','8712100647864','8710400528159','4065019015144',
  '8718907867047','8718907177511','8714100330968','8712100428715',
  '8718452927258','8716221205699','8710522987766','8718452766956','20299729',
  '8710400385356',
  '8719587130445','4001724016588','00749145','8719587206669','8718452908707',
  '5900852044618','4260414153426','8718989079857','8718906791503','4056489757535',
  '4001724050650','8718906616431',
  '8721317707469','8710908929571','7613035752245',
  '4030800199358','8710506086645','8718907539937',
  '8715108224266','8710398533326','8710861986710','8710861010200',
  '7290111562136',
  '8445291660748','5420005733058','8718907100373'
);

update public.product_features set swap_family='meat_snacks', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: snackworst (bifi, kabanossi, knak-/bock-/cocktailworst, aperitiefsalami) is een borrelsnack, geen broodbeleg (wortel gefixt in R18b)'
where barcode in (
  '4251097400136','4251097401447','4251097402659','4251097408903','4251097420783',
  '4056489609124','20044596','27039984','5908230539343',
  '8720182327918','8712100806087','8720182686794','8714100753736','8714100772928',
...
update public.product_features set swap_family='meal_components', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: rookworst/braadworst/verse pasta/ovenpasta/hamburger/spekreepjes zijn maaltijdcomponenten, geen broodbeleg'
where barcode in (
  '8710400252146','8710604729611','8720182718495','8710624241070','8714100777701',
  '8710400067405','8710400250456','8712100647864','8710400528159','4065019015144',
  '8718907867047','8718907177511','8714100330968','8712100428715',
...
update public.product_features set swap_family='ready_meals', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: pizza/nasi/witlofschotel/quiche/babymaaltijd met ham of salami is een maaltijd (wortel gefixt in R18)'
where barcode in (
  '8719587130445','4001724016588','00749145','8719587206669','8718452908707',
  '5900852044618','4260414153426','8718989079857','8718906791503','4056489757535',
  '4001724050650','8718906616431');
...
update public.product_features set swap_family='soups', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0085: Cup-a-Soup is soep, geen vleeswaren'
where barcode in ('8721317707469','8710908929571');

update public.product_features set swap_family='sauces_dips', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0085: ham-kaassaus is een saus'
where barcode in ('7613035752245');

update public.product_features set swap_family='savory_spreads', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: smeersalade (Fleischsalat, ham-preisalade, salade-specialiteit) is hartig broodbeleg'
where barcode in ('4030800199358','8710506086645','8718907539937');

update public.product_features set swap_family='bread_bakery', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: ham-kaascroissant hoort bij brood/viennoiserie'
where barcode in ('8715108224266');

update public.product_features set swap_family='crisps_chips', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0085: chips met hamsmaak is chips'
where barcode in ('8710398533326');

update public.product_features set swap_family='fried_snacks', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0085: (oven)frikandel/fricadelle is een fried snack'
where barcode in ('8710861986710','8710861010200');
...
update public.product_features set swap_family='meat_alternatives_non_swap', is_swap_relevant=false, classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0085: vega wok pieces zijn een vleesvervanger-maaltijdcomponent; vegan BELEG blijft bewust in cold_cuts'
where barcode in ('7290111562136');
...
update public.product_features set swap_family=null, classification_status='review_required',
  ...
  classification_reason='audit1_0085: producttype onduidelijk (Crispy Twist: snack of vleesvervanger; Vegan Deli Bell Pepper; Mini crocq komijn)'
where barcode in ('8445291660748','5420005733058','8718907100373');

-- R18/R18b: regelwortel-fixes, volledige functie hieronder.
-- POSTFLIGHT: select count(*) from product_features where classification_reason like 'audit1_0085%'; -- 68
-- ROLLBACK: herstel via _snapshot_0085_before.
