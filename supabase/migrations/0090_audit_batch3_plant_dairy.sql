-- Fase 1 audit, batch 3 (zuivel/spreads) — deel 5 (slot): leesronde
-- plant_based_dairy (249). Elk product individueel gelezen. Daarmee is
-- batch 3 compleet.
--
-- De familie is als DRANK/lepelzuivel-alternatief bedoeld. Drie groepen
-- hoorden er niet in:
--  K1 16 plantaardige KAASvervangers (Violife, Soyananda, Boursin végétal,
--     Gondino, Vairy/AH/Jumbo plantaardige plakken + rasp, Dream Farm
--     burrata, Fermentino, Veggi Filata) -> cheese_snacks, consistent met
--     0084 (kaasvervangers staan bewust bij de kaasfamilie). Pa'lais Nature
--     -> savory_spreads, consistent met de andere Pa'lais-smaken.
--  K2 21 plantaardige KOOKroom-producten (cuisine/kochcreme/kochsahne/
--     keukenroom/crème fraîche/whipping/slagroom-topping/creamers) ->
--     dairy_cooking_cream_non_swap: kookingredient, geen snack-swap.
--  K3 25 blik-KOKOSMELK (Go-Tan, Fair Trade Original, Mae Ploy, Sum & Sam,
--     Asia Green Garden, AH/Jumbo/Picnic "kokosmelk", incl. "romige
--     kokosmelk 18% vet") -> dairy_cooking_cream_non_swap. In het NL-schap
--     is "kokosmelk" het blik voor curry's en "kokosdrink" de beverage; die
--     laatste blijft plantaardige zuivel.
--
-- Regelwortels: R29 (plantaardige kaas -> cheese_snacks), R28 (plantaardige
-- kookroom -> cooking cream), R27 (kokosmelk/coconut milk zonder 'drink' ->
-- cooking cream). Alle drie vóór de plantaardige-zuivelregel geplaatst.
--
-- NB bewust ongemoeid: "Lait De Coco Nature" (merk zegt expliciet FOR
-- DRINKING) en Rude Health coconut milk (drankmerk) blijven plantaardige
-- zuivel; "Mild & romig" (Melkan) en "Halfvolle drink" (AH) zijn te vaag om
-- te verplaatsen (twijfel).
--
-- `products` wordt nergens aangeraakt. `products` blijft raw.

create table if not exists public._snapshot_0090_before as
...
where barcode in (
  '3073781173468','8030172002009','5202390024597','5202390030680','4260007663431',
  '8009750923814','8053435070218','8713442577956','8718907346023','8718907411219',
  '8718907425964','8718452909186','5202390017834','4056489474760','5202390015878',
  '7610612003554',
  '5430001428018',
  '5425000192084','8023678423409','5411788047005','5411788045612','5411188121602',
  '8718907094580','5411188121329','4062800014911','5425000191124','5411188124375',
  '5411788046992','5411188124320','8718906846586','5411188121435','8718907094818',
  '8718452549863','8719200290341','8719200285040','8717496906700','8718907226950',
  '8718452120727',
  '8718907766548','0041224860025','5032722304413','8710605096170','8850367992331',
  '8720326098926','8713576114102','8718976020145','8711741305355','8711741360002',
  '8718989062064','8711741355022','8718989062101','8718906243026','8711521924875',
  '8718906896130','8720326100407','8718989062088','4068706495793','8710605096163',
  '8718452367290','8718452251766','8718452558636','8711741355916','8718452877157'
);

update public.product_features set swap_family='cheese_snacks', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0090: plantaardige kaasvervanger (plakken/rasp/Violife/Soyananda/gouda-smaak) hoort bij de kaasfamilie, consistent met 0084 (wortel gefixt in R29)'
where barcode in (
  '3073781173468','8030172002009','5202390024597','5202390030680','4260007663431',
  '8009750923814','8053435070218','8713442577956','8718907346023','8718907411219',
  '8718907425964','8718452909186','5202390017834','4056489474760','5202390015878',
...
update public.product_features set swap_family='savory_spreads', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0090: Pa''lais Nature is een smeerspread, consistent met de andere Pa''lais-smaken in savory_spreads'
where barcode in ('5430001428018');
...
update public.product_features set swap_family='dairy_cooking_cream_non_swap', is_swap_relevant=false, classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0090: plantaardige kookroom/slagroom-alternatief (cuisine/kochcreme/keukenroom/fraiche/whipping/topping/creamers) is een kookingredient, geen snack-swap (wortel gefixt in R28)'
where barcode in (
  '5425000192084','8023678423409','5411788047005','5411788045612','5411188121602',
  '8718907094580','5411188121329','4062800014911','5425000191124','5411188124375',
  '5411788046992','5411188124320','8718906846586','5411188121435','8718907094818',
...
update public.product_features set swap_family='dairy_cooking_cream_non_swap', is_swap_relevant=false, classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0090: blik-kokosmelk (curry-kookmelk, vaak 18% vet) is een kookingredient; "kokosdrink" blijft plantaardige zuivel (wortel gefixt in R27)'
where barcode in (
  '8718907766548','0041224860025','5032722304413','8710605096170','8850367992331',
  '8720326098926','8713576114102','8718976020145','8711741305355','8711741360002',
  '8718989062064','8711741355022','8718989062101','8718906243026','8711521924875',
...
-- R27/R28/R29: regelwortel-fixes, volledige functie hieronder.
-- POSTFLIGHT: select count(*) from product_features where classification_reason like 'audit1_0090%'; -- 63
-- ROLLBACK: herstel via _snapshot_0090_before.
