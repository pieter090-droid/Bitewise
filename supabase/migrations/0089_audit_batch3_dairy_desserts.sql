-- Fase 1 audit, batch 3 (zuivel/spreads) — deel 4: leesronde dairy_desserts
-- (197). Elk product individueel gelezen. Deze familie was fors vervuild:
-- veel yoghurt/skyr/kwark en plantaardige desserts kwamen hier via legacy-AI
-- (niet via de regelengine — de dairy_desserts-regel vereist pudding/mousse/
-- vla/dessert + zuivel-pnns, en heeft die niet toegekend).
--
-- Hoofdbevindingen:
--  K1 40 plantaardige desserts/yoghurt (Alpro, Provamel, Oatly, Abbot
--     Kinney's, Vemondo, AH Terra soja/haver/amandel/kokos-"gurt", Jumbo
--     plantaardig, Danone Pflanzlich, Jörd, Nemoloko, beleaf) ->
--     plant_based_dairy. Regelwortel R26 (plant-merken + 'op basis van X' /
--     'soja/oat gurt' vóór de zuiveldessert-regel).
--  K2 36 dairy yoghurt/skyr/kwark (FAGE, Activia, Oikos, Hipro-bekers,
--     biogarde/roer, hangop, Kvarg/Qarc, Sterke Start, Cultura, diverse
--     "(Griekse) yoghurt/jogurt") -> yoghurt_skyr_quark.
--  K3 3 drinkbare zuivel (Actimel kids, Vifit Goedemorgen x2) ->
--     dairy_drinks; koffiemelk (lait pour café) ->
--     dairy_cooking_cream_non_swap; Calvé yoghurt-slasaus -> sauces_dips;
--     Becel ProActiv (margarine of drink onduidelijk) -> review_required.
--  NB echte zuiveldesserts (vla, mousse, pudding, tiramisu, crème brûlée/
--     catalane, flan, panna cotta, custard, Danoontje, rijstpudding,
--     wolkentoetje) blijven bewust in dairy_desserts. Enkele ambigue
--     eennaam-bekers (Boerderij Zuivel, Naturel Jumbo, Perly, Coco Jumbo)
--     bewust ongemoeid gelaten (twijfel).
--
-- `products` wordt nergens aangeraakt. `products` blijft raw.

create table if not exists public._snapshot_0089_before as
...
where barcode in (
  '5411188121213','5411188102809','5411188125808','5411188138594','5411188121411',
  '5411188121398','5411188080190','5411188080183','5411188511342','5411188511359',
  '7394376621628','8719587268506','8718907825030','8719587109724','8718906981164',
  '8718907226974','8718907226967','8719587068960','8718907227025','8718907227063',
  '8718907117029','4056489412175','4056489724087','4056489029915','4056489466598',
  '4335619137028','8718452815098','8718452545308','8718452966424','8718452541805',
  '8719189236712','8719189236514','5711953176753','6408659990835','4680019566719',
  '4009700072993','4009700074249','8002670500165','8720326083687','8003938009321',
  '4027394002829','5410146417887','5410146417894','4104060028731','8718452671939',
  '8718452362691','8711399021126','8695077105011','5201054015681','5201054082034',
  '5201054015360','8716376000705','8710624355678','8710400023180','8718657570907',
  '8718719070123','8713788123855','8713788124166','8713788123879','8713788123404',
  '23065031','5690845003691','5690845001994','3023290026489','8718452671946',
  '8713788124142','8718657571805','8593807759247','8713788122513','8711399022680',
  '0872232475730','20491543','8717948145008','8718166008106','8712800000938',
  '5711953195921',
  '8713788123794','8712800148487','8712800148456',
  '20047610','8711200484690','8719200214378'
);

update public.product_features set swap_family='plant_based_dairy', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0089: plantaardig dessert/yoghurt (Alpro/Provamel/Oatly/Abbot Kinney/Vemondo/AH Terra soja-haver-gurt/Jumbo plantaardig) is plantaardige zuivel (wortel gefixt in R26)'
where barcode in (
  '5411188121213','5411188102809','5411188125808','5411188138594','5411188121411',
  '5411188121398','5411188080190','5411188080183','5411188511342','5411188511359',
  '7394376621628','8719587268506','8718907825030','8719587109724','8718906981164',
...
update public.product_features set swap_family='yoghurt_skyr_quark', classification_confidence=0.6, classified_at=now(),
  classification_reason='audit1_0089: dagverse yoghurt/skyr/kwark (FAGE/Activia/Oikos/Hipro-beker/biogarde/hangop/Kvarg/Sterke Start) hoort in yoghurt_skyr_quark, geen dessert'
where barcode in (
  '4027394002829','5410146417887','5410146417894','4104060028731','8718452671939',
  '8718452362691','8711399021126','8695077105011','5201054015681','5201054082034',
  '5201054015360','8716376000705','8710624355678','8710400023180','8718657570907',
...
update public.product_features set swap_family='dairy_drinks', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0089: Actimel/Vifit Goedemorgen is drinkbare zuivel, geen lepeldessert'
where barcode in ('8713788123794','8712800148487','8712800148456');

update public.product_features set swap_family='dairy_cooking_cream_non_swap', is_swap_relevant=false, classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0089: lait pour café is koffiemelk, geen dessert'
where barcode in ('20047610');

update public.product_features set swap_family='sauces_dips', classification_confidence=0.55, classified_at=now(),
  classification_reason='audit1_0089: Calvé yoghurt-slasaus is een saladesaus, geen dessert'
where barcode in ('8711200484690');
...
update public.product_features set swap_family=null, classification_status='review_required',
  ...
  classification_reason='audit1_0089: Becel ProActiv onduidelijk (margarine of cholesterol-drankje)'
where barcode in ('8719200214378');

-- R26: regelwortel-fix, volledige functie hieronder.
-- POSTFLIGHT: select count(*) from product_features where classification_reason like 'audit1_0089%'; -- 82
-- ROLLBACK: herstel via _snapshot_0089_before.
